...
import io.github.fantasmadux.authmicro.grpc.AccountCreationServiceGrpc;
import io.github.fantasmadux.authmicro.grpc.AccountValidatorServiceGrpc;
import io.github.fantasmadux.authmicro.grpc.GetAccountInfoServiceGrpc;
...
public class GrpcClientConfig {
    ...
    private ManagedChannel createChannel(String target) {
        try {
            ...
            log.warn("Нет подключения к userMicro");
            throw new ServerAnswerException();
        }
    }
}